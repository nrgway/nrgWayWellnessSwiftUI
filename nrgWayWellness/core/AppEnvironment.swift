...
extension AppEnvironment {
    ...
    private static func configuredWebRepositories(session: URLSession) -> DIContainer.WebRepositories {
        ...
        return .init(imageRepository: imageWebRepository,
                     ...
                     onboardingRepositioning: onboardingRepository)
    }
...
//    }
    ...
    private static func configuredInteractors(appState: Store<AppState>,
        ...
        let onboardingInteractor = OnboardingInteractor(
            webRepository: webRepositories.onboardingRepositioning as! OnboardingRepository)
        
        return .init(countriesInteractor: countriesInteractor,
                     imagesInteractor: imagesInteractor,
                     userPermissionsInteractor: userPermissionsInteractor,
                     onboardingIntractable: onboardingInteractor)
    }
}
...
extension DIContainer {
    struct WebRepositories {
        ...
        let onboardingRepositioning: OnboardingRepositioning
    }
