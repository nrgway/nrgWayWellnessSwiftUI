//
//  SingleVideoDataVideo.swift
//  nrgWayWellness
//
//  Created by Hosein Alimoradi on 8/16/1399 AP.
//  Copyright © 1399 wellness. All rights reserved.
//  SingleVideoDataCreator

import Foundation

struct SingleVideoDataVideo : Codable {
            ...
            init(from decoder: Decoder) throws {
                    ...
                    categories = try values.decodeIfPresent([SingleVideoDataCategory].self, forKey: .categories)
