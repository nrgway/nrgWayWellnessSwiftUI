...
struct VideosForTrainerData : Codable {

        let createdAt : String?
        let creator : VideosForTrainerDataCreator?
        ...
        init(from decoder: Decoder) throws {
                ...
                creator = try VideosForTrainerDataCreator(from: decoder)
