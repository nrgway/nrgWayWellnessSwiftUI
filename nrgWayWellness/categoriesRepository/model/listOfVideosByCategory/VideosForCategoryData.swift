...
struct VideosForCategoryData : Codable {

        let createdAt : String?
        let creator : VideosForCategoryDataCreator?
        ...
        init(from decoder: Decoder) throws {
                ...
                creator = try VideosForCategoryDataCreator(from: decoder)
